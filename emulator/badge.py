...
class Badge:
    def __init__(self):
        ...
        self.progMem = []
        # self.pc = 0
        self.acc = [0b0000, 0b0000, 0b0000]  # lower  # middle  # upper
        self.cFlag = [0b0, 0b0, 0b0]  # lower  # middle  # upper
        self.zFlag = [0b0, 0b0, 0b0]  # lower  # middle  # upper
        self.vFlag = [0b0, 0b0, 0b0]  # lower  # middle  # upper
        self.userCarry = 0b0
        self.adders = [
            0b0000,  # dest bits
            0b0000,  # source bits
